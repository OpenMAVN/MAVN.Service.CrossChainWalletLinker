...
namespace Lykke.Service.CrossChainWalletLinker.Contract.Linking
{
    /// <summary>
    /// Wallet linking status change has been completed in private blockchain
    /// </summary>
    public class WalletLinkingStatusChangeCompletedEvent
    {
        /// <summary>
        /// The customer id
        /// </summary>
